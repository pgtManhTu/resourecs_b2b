					...
					<form>
						<div class="p_tabs">
							<ul class="p_tabs__btns">
								...
								<li><a href="#paid_func" class="current">有料機能</a></li>
							</ul>
							...
							<div id="paid_func" class="p_tabs__content">
								<div class="p_tabs__content-onoff">
									...
									<div class="item">
										<span class="c_label">有料機能 B :</span>
										<div class="c_radio">
											<input type="radio" name="options-b" id="options-b1" value="options-b1">
											<label for="options-b1">利用する</label>

											<input type="radio" name="options-b" id="options-b2" value="options-b2" checked>
