    ...
    <div class="f_main-area">
      ...
      <main class="l_main">
        ...
        <div class="p_main-content">
          ...
          <div class="c_table-wide p_table-prodreg">
            <table class="c_table-wide__inner">
              <tbody>
                ...
                <tr>
                  <td data-label="項目"><div>商品名 <span class="txt-error">*</span></div></td>
                  <td data-label="内容">
                    <div>
                ...
                <tr>
                  <td data-label="項目"><div>商品説明 <span class="txt-error">*</span></div></td>
                  <td data-label="内容">
                    <div>
                ...
                <tr>
                  <td data-label="項目"><div>商品画像 <span class="txt-error">*</span></div></td>
                  <td data-label="内容">
                    <div>
                      <ul>
                        <li>
                ...
                <tr>
                  <td data-label="項目"><div>製品ビデオ</div></td>
                  <td data-label="内容">
                    <div>
                      <ul>
                        <li class="play-icon">
                ...
                <tr>
                  <td data-label="項目"><div>メーカー名 <span class="txt-error">*</span></div></td>
                  <td data-label="内容">
                    <div>
                ...
                <tr>
                  <td data-label="項目"><div>型式 <span class="txt-error">*</span></div></td>
                  <td data-label="内容">
                    <div>
                ...
                <tr>
                  <td data-label="項目"><div>単位 <span class="txt-error">*</span></div></td>
                  <td data-label="内容">
                    <div>
                ...
                <tr>
                  <td data-label="項目"><div>価格 <span class="txt-error">*</span></div></td>
                  <td data-label="内容">
                ...
                <tr>
                  <td data-label="項目"><div>SKU</div></td>
                  <td data-label="内容">
                    <div>
                ...
                <tr>
                  <td data-label="項目"><div>納期</div></td>
                  <td data-label="内容">
                    <div>
                ...
                <tr>
                  <td data-label="項目"><div>関連商品</div></td>
                  <td data-label="内容">
                    <div class="rel-prod">
                      <div class="tag-cont">
                ...
                <tr>
                  <td data-label="項目"><div>特記事項</div></td>
                  <td data-label="内容">
                    <div>
          ...
          <?php include('_product-details-modal.php'); ?>
