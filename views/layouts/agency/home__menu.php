...
<body>
  <div class="clearfix">
    <div class="f_main-area f_main-home show"><!-- just remove the class "show" to hide the sidebar menu -->
                ...
                <ul class="p_notif__list">
                  <li>
                    ...
                    <div class="btns">
                      ...
                      <button class="c_btn-icon favorite"></button>
                    </div>
                  </li>
                  <li>
              ...
              <div class="p_home__listbox">
                ...
                <table class="p_home-table">
                  ...
                  <tr>
                    <td>2023年8月31日</td>
                    <td>ABC販売店<br>A9999999XYZ</td>
                    <td><span class="c_status" data-user-status="2">承認待</span></td>
                  </tr>
                  <tr>
                    <td>2023年8月31日</td>
                    <td>ABC販売店<br>A9999999XYZ</td>
