          ...
          <div class="p_home__cont">
              ...
              <div class="p_notif">
                <div class="p_notif__hdng">
                  <div>
                    ...
                    <h4 class="p_notif__ttl">お知らせ<small class="c_notif-side pc-only">2</small></h4>
                ...
                <ul class="p_notif__list">
                  ...
                  <li>
                    ...
                    <div class="star">
                      ...
                      <label class="c_btn-icon favorite" for="star5"></label>
                    </div>
                    </div>
                  </li>
                  <li>
                    ...
                    <div class="star">
                      ...
                      <label class="c_btn-icon favorite" for="star6"></label>
                    </div>
                    </div>
                  </li>
                  <li>
                    ...
                    <div class="star">
                      ...
                      <label class="c_btn-icon favorite" for="star7"></label>
                    </div>
                    </div>
                  </li>
                </ul>
            ...
            <div class="p_home__boxes">
              <div class="p_home__box">
                ...
                <h3 class="ttl">見積回答</h3>
                <p class="txt">受信済の 見積一覧を見ます</p>
              ...
              <div class="p_home__listbox">                                                                                                                                                                                                   
                ...
                <table class="p_home-table">
                  ...
                  <tr>
                    <td>2023年8月31日</td>
                    <td>ABC販売店<br>A9999999XYZ</td>
                    <td><span class="c_status" data-user-status="4">受付済</span></td>
                  </tr>
                  <tr>
                    <td>2023年8月31日</td>
                    <td>ABC販売店<br>A9999999XYZ</td>
