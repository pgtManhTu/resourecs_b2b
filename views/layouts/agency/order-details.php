      ...
      <main class="l_main">
        ...
        <div class="p_main-content">
          ...
          <div class="c_table-list p_table-orderdtail">
            <div class="c_mb-10">注文番号：No.5</div>
            <div class="c_table__scroll c_scrollbar">
              <table class="c_table-list__inner">
                ...
                <tr>
                  ...
                  <td>20円</td>
                  <td>7～10日</td>
                  <td rowspan="2"><span class="c_status" data-user-status="3">入荷待ち</span></td>
                </tr>
                <tr>
            ...
            <div class="p_list-orderdtail">
              <ul>
                <li>
                  ...
                  <div class="cont"><input type="text" id="" name="" value="株式会社ABC"></div>
                </li>
                <li>
                  <span class="label">お問い合わせの回答</span>
                  <div class="cont"><input type="text" id="" name="" value="商品の仕様についての質問"></div>
                </li>
                <li>
